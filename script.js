...
function goBack() {
    ...
    if (currentPage === 'page3') {
        ...
        showPage('page35');
    } else if (currentPage === 'page37') {
        showPage('page36');
    } else if (currentPage === 'page38') {
        showPage('page37');
    } else if (currentPage === 'page39') {
        showPage('page38');
    } else if (currentPage === 'page40') {
        showPage('page39');
    } else if (currentPage === 'page41') {
        showPage('page40');
    } else if (currentPage === 'page42') {
        showPage('page41');
    } else if (currentPage === 'page43') {
        showPage('page42');
    } else if (currentPage === 'page44') {
        showPage('page43');
    } else if (currentPage === 'page45') {
        showPage('page44');
    } else if (currentPage === 'page46') {
        showPage('page45');
    } else if (currentPage === 'page47') {
        showPage('page46');
    } else if (currentPage === 'page48') {
        showPage('page47');
    } else if (currentPage === 'page49') {
        showPage('page48');
    } else if (currentPage === 'page50') {
        showPage('page49');
    } else if (currentPage === 'page51') {
        showPage('page50');
    } else if (currentPage === 'page52') {
        showPage('page51');
    } else if (currentPage === 'page53') {
        showPage('page52');
    } else if (currentPage === 'page54') {
        showPage('page53');
    } else if (currentPage === 'page55') {
        showPage('page54');
    } else if (currentPage === 'page56') {
        showPage('page55');
    } else if (currentPage === 'page57') {
        showPage('page56');
    } else if (currentPage === 'page58') {
        showPage('page3');
    } else if (currentPage === 'page59') {
        showPage('page57');
        ...
        showPage('page62');
    } else if (currentPage === 'page64') {
        showPage('page63');
    } else if (currentPage === 'page65') {
        showPage('page64');
    } else if (currentPage === 'page66') {
        showPage('page65');
    } else if (currentPage === 'page67') {
        showPage('page66');
    } else if (currentPage === 'page68') {
        showPage('page67');
    } else if (currentPage === 'page69') {
        showPage('page68');
    } else if (currentPage === 'page70') {
        showPage('page69');
    } else if (currentPage === 'page71') {
        showPage('page70');
    } else if (currentPage === 'page72') {
        showPage('page71');
    } else if (currentPage === 'page73') {
        showPage('page72');
    } else if (currentPage === 'page74') {
        showPage('page73');
    } else if (currentPage === 'page75') {
        showPage('page74');
    } else if (currentPage === 'page76') {
        showPage('page75');
    }
}
